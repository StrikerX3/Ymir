...
public:
    ...
    /// @param[in] vdp2AccessPatternsConfig a reference to the VDP2 access patterns configuration
    ...
    Direct3D11VDPRenderer(VDPState &state, config::VDP2DebugRender &vdp2DebugRenderOptions,
                          const config::VDP2AccessPatternsConfig &vdp2AccessPatternsConfig, ID3D11Device *device,
