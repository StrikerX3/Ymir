...
function(compile_hlsl_shader)
    ...
    get_filename_component(BASE_PATH "${SHADER_SOURCE}" DIRECTORY)
    ...
    set(DEP_FILE "${SHADER_OUTPUT_DIR}/${BASE_PATH}/${FINAL_NAME}.d")
    set(SHADER_OUTPUT "${SHADER_OUTPUT_DIR}/${BASE_PATH}/${FINAL_NAME}.cso")
